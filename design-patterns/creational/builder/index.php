 ...
 * the builder steps a little bit differentlyfrom the others.
 * 
...
class MysqlQueryBuilder implements SQLQueryBuilder 
{
  ...
  public function where(string $field, string $value, string $operator = "="): SQLQueryBuilder 
  {
    if (!in_array($this->query->type, ['select', 'updated', 'delete'])) {
 ...
 * similiar to MySQL, it strill has several differences. To reuse the common code,
