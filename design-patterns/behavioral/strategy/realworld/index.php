...
/**
 * Strategy is a behavioural design pattern that turns a set of behaviour into objects and
 ...
 * 
 * Each payment method can display a payment form to collect proper payment details from a user and send it to the payment processing company. 
 * Then, after the payment processing company redirects the user back to our website, 
 * the payment method validates the return parameters and helps to decide whether the order was completed.
 */
